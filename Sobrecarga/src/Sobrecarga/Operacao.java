...
private int nroFatorial = 0;
	/*
	Em uma subtração nroMinuento - nroSubtraendo = nroDiferenca,
	nroMinuendo é chamado minuendo,
	nroSubtraendo é chamado subtraendo e
	nroDiferença é chamado resto ou diferença
	 */
	...
	public int divisao() {
		//na divisão inteira quando os operandos envolvidos forem do tipo inteiro (quociente da divisão);
		//% na definição do resto da divisão
		return this.nroGenerico1 / this.nroGenerico2;
	}
	//Sobrecarga
